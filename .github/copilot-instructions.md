...
- **Cohort 1 Outgoing** (Jul 20–26): `Cohort #1 outgoing/cohort1_week.html` — navy theme
- **Cohort 2 Incoming** (Jul 27–Aug 2): `Cohort #2 incoming/cohort2_week.html` — green theme
- Template for all day cards: `Cohort #1 outgoing/innovation_tour.html` (Jul 21, fully built)
...
## Publishing
- Target: **GitHub Pages** (`yourusername.github.io/nia-redi-immersion`)
- Before publishing: rename `cohort1_week.html` → `index.html` so it loads as the homepage
- All internal links already use relative paths — no changes needed for Pages to work
- Update the live site anytime by pushing changes to the repo
